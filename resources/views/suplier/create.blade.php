 ...
 <form action="{{ route('suplier.store') }}" method="POST">
   ...
   <div class="border-b border-gray-900/10 pb-12">
     ...
     <div class="mt-5 col-span-full gap-y-8">
       ...
       <div class="mt-5 col-span-full gap-y-8">
         <label for="telepon_suplier" class="block text-sm/6 font-medium text-gray-900">Phone Number</label>
           <div class="mt-2">telepon
             <input id="telepon_suplier" name="telepon_suplier" type="telepon_suplier" autocomplete="telepon_suplier" value="{{ old('telepon_suplier') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
           </div>
       </div>
     </div>
     <div clas s="mt-6 flex items-center justify-end gap-x-6">
