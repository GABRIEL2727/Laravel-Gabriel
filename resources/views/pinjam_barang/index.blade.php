...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
  ...
  <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
      <div>
          <h3 class="text-lg font-semibold text-slate-800">Data pinjam_barangs</h3>
          <p class="text-slate-500">A list of all the pinjam_barangs acount..</p>
      </div>
      <div class="ml-3">
          ...
          <div class="relative">
              ...
              placeholder="Search for pinjam_barang data..."
              />
              <button
  ...
  <table class="w-full text-left table-auto min-w-max">
      ...
      <tr class="hover:bg-slate-50 border-b border-slate-200">
          ...
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500">{{ $pinjam_barang->id_pinjam }}</p>
          </td>
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500">{{ $pinjam_barang->peminjam}}</p>
          </td>
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500">{{ $pinjam_barang->tanggal_pinjam }}</p>
          </td>
          <td class="p-4 py-5">
            <p class="text-sm text-slate-500">{{ $pinjam_barang->id_barang}}</p>
            </td>
            <td class="p-4 py-5">
          ...
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500"><a href="{{ route('pinjam_barang.edit', $pinjam_barang->id) }}" class="font-medium text-blue-600 hover:text-blue-800">Edit</a></p>
          </td>
          <td class="p-4 py-5">
